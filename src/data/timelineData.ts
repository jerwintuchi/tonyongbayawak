...
export const timelineData = [
    ...
    { title: "Initial Testing", date: "October 2022", description: "Conducted preliminary testing of our model with historical data and achieved promising results.", icon: GrTest  },
