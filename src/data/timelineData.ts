...
export const timelineData = [
    ...
    { title: "Data Cleaning and Preprocessing", date: "September 2022", description: "Started developing our proprietary AI algorithms and testing different machine learning approaches.", icon: Code, link: "/about/model-development" },
    { title: "Model Training and Fine-Tuning", date: "October - December 2022", description: "Conducted preliminary testing of our model and fine-tuned it based on comparison of forecast performance with other forecasting models.", icon: LuBrainCircuit, link: "/about/model-training-and-fine-tuning" }, // Updated icon to LuBrainCircuit", icon: LuBrainCircuit, link: "/about/initial-testing" },
