...
export default function RMSESection() {
    return (
        <div className="max-w-6xl mx-auto bg-white bg-opacity-10 p-8 mt-8 rounded-lg shadow-lg">
            ...
            <RMSEFormula />
            <h2 className="text-3xl text-blue-300 font-semibold mb-4">RMSE Accuracy Table</h2>
            ...
            <p className='text-gray-300 pb-4'>
                ...
                are properly accounted for, making RMSE a reliable metric for financial forecasting most especially for a crypto asset such as AXS.
            </p>
